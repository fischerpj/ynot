// superStorage coerces storageItem cache to superArray offering get_random_from_cache
...
// 3.
console.log(storage.get_random_from_cache().toString());  
