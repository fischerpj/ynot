...
bibRefInstance.fetchContent().then((resp) => console.log(resp.content));  // This will initially be null until fetchContent is called

//console.log(bibRefInstance.response);  // This will initially be null until fetchContent is called