...
> Third attempt to fastCheck validity of BibleRef *THEN* fetch&display (with *observableJS).*
...
append = (() => {
  document.getElementById("outputDiv").innerHTML = JSON.stringify(bcve)
  })();
