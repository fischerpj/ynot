...
//    this.dataDicts = require('./BibleBooksCodes_Tables');
	 ...
	 this.size = size;
	 this.random = this.getBBBsample_(this.size);
...
export class BookRef extends BibleBooksCodes {
  ...
  constructor(
    ...
    size= 7) {
      super(size); // create instance of parent 
...
export class Refs extends BibleBooksCodes {
  static dict = {
    key1: 'value1',
    key2: 'value2',
    key3: 'value3'
