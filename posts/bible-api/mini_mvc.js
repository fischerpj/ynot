...
class mStorage {
  ...
  constructor(defaultKeyId = 'refidArrayNext', 
              initValue    = "gen1:1") {
 ...
 */
    ...
    this.helpButton.classList.add("btn", "btn-info");
...
*/
  ...
  // Appends two divs to the container
    this.rowDiv.appendChild(this.viewButton);
    this.rowDiv.appendChild(this.helpButton);
